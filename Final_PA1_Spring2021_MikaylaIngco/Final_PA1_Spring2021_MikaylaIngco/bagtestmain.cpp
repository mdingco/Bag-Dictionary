...
int main(int argc, char** argv) {
	...
	cout << "<Mikayla Ingco> -- CSIS 215 Programming Assignment 1 -- Bag Dictionary" << endl << endl;
	...
	cout << "-----------------------------------------------------------------------------" << endl;
	ABag<KVpair<int, string>> myBag = ABag<KVpair<int, string>>(10);		 //Used to test bag functions not previously demonstrated

	cout << "Testing unused functions from ABag.h: " << endl;

	KVpair<int, string> test = KVpair<int, string >(1, "One");

	cout << "+=" << endl;
	KVpair<int, string> x_test = KVpair<int, string>(2, "Two");		//Make a new KVpair to append

	myBag.inspectTop(test);
	cout << "Old value of top of bag: " << test.value() << endl;
	myBag += x_test;																			//Append to bag
	myBag.inspectTop(test);
	cout << "New value of top of bag: " << test.value() << endl << endl;
